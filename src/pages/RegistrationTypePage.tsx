          ...
          <div className="glass-effect rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full p-6 bg-gradient-to-r from-secondary-500 to-secondary-600 text-white rounded-2xl hover:from-secondary-600 hover:to-secondary-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-secondary-100 text-sm">Pour les professionnels de santé</p>
                    </div>
                  </div>
              ...
              <button
                ...
                className="w-full p-6 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-2xl hover:from-primary-600 hover:to-primary-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-white/20 rounded-xl group-hover:bg-white/30 transition-colors">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-primary-100 text-sm">Pour les établissements de santé</p>
                    </div>
                  </div>
                  <div className="text-3xl">→</div>
                </div>
