        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-sky-500 hover:bg-sky-600 rounded-xl transition-colors disabled:opacity-60 shadow-sm"
            >
              {pdfLoading
            ...
            {loading ? <ChartSkeleton /> : consChart.length === 0 || consChart.every(c => c.consultations === 0) ? (
              ...
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={consChart}>
                  ...
                  <Line type="monotone" dataKey="consultations" stroke="#0ea5e9" strokeWidth={2.5}
                    dot={{ fill: '#0ea5e9', r: 4 }} name="Consultations" />
                </LineChart>
              </ResponsiveContainer>
            )}
          </ChartCard>
            ...
            {loading ? <ChartSkeleton /> : (
              <ResponsiveContainer width="100%" height={230}>
                <AreaChart data={growthChart}>
                  ...
                  <YAxis tick={CHART_STYLE.label} axisLine={false} tickLine={false} />
                  <Tooltip contentStyle={CHART_STYLE.tooltip} />
                  <Area type="monotone" dataKey="patients" stroke="#0ea5e9" strokeWidth={2.5}
                    ...
                    {topDoctors.map((d, i) => (
                      <tr key={i} className="border-t border-slate-50 dark:border-white/[0.04] hover:bg-slate-50/50 dark:hover:bg-white/[0.02]">
                        ...
                        <td className="px-4 py-2.5 text-center">
                          <span className="font-bold text-sky-600 dark:text-sky-400">{d.patients}</span>
                        </td>
                        <td className="px-4 py-2.5 text-center">
